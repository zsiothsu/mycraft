...
double Perlin::Cosine_Interpolate(double a, double b, double x)
{
...
double Perlin::Linear_Interpolate(double a, double b, double x)
{
    return a * (1 - x) + b * x;
}

double Perlin::InterpolatedNoise(float x, float y)
{
    int integer_X = int(x);
